...
<body>
    ...
    <main class="container" style="margin:auto; flex: 70%;">
        <h1 class="my-5"><?php if (isset($editingTask)) {
                                echo "Edit";
                            } else {
                                echo "Assign";
                            } ?> Task</h1>
        <form autocomplete="off" method="post" action="">
            ...
            <div class="form-group row">
                ...
                <div>
                    <input type="title" name="title" class="form-control" id="title" placeholder="..." maxlength="255" required value="<?php if (isset($editingTask)) {
                                                                                                                                            echo $editTaskTitle;
                                                                                                                                        } ?>">
                </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: 0px; margin-right: 0px;">
                ...
                <textarea class="form-control" id="description" name="description" rows="10" placeholder="..." maxlength="1000" required><?php if (isset($editingTask)) {
                                                                                                                                                echo $editTaskDesc;
                                                                                                                                            } ?></textarea>
            </div>
            ...
            <div style="display: flex;">
                <div style="flex-direction: row;">
                    ...
                    <input type="number" id="manhours" name="manhours" class="form-control" placeholder="Hours" style="width: 250px;" min="1" required value=<?php if (isset($editingTask)) {
                                                                                                                                                                    echo $editTaskHours;
                                                                                                                                                                } ?>>
                </div>
                <div style="flex-direction: row; margin-left: 50px;">
                    <label for="date">Select Due Date</label>
                    <input class="form-control" id="date" name="date" type="date" style="width: 250px;" required value="<?php if (isset($editingTask)) {
                                                                                                                            echo $editTaskDate;
                                                                                                                        } ?>">
                    <script>
                        let date = new Date();
    ...
    <script>
        ...
        <?php if (isset($editingTask)) {
            echo "setSearch('emp', 'emp_li_$setEmpTo')";
        } ?>
    </script>
