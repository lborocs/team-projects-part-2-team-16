		...
		<div class="container  settingsCSS <?php echo $colour;?>">
			<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start settingsCSS <?php echo $colour;?>">
				...
				<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
					...
					<li><a href="./view_topics_m.php" class="nav-link px-2 settingsCSS <?php if($topicview=="link-dark"){echo $colour;}echo $topicview;?>">Topics</a></li>
					<li><a href="./create_task_m.php" class="nav-link px-2 settingsCSS <?php if($taskcreate=="link-dark"){echo $colour;}echo $taskcreate;?>">Assign Tasks</a></li>
				</ul>
