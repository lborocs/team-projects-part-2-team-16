...
<body class = "<?php echo $colour;?>";>
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert" style = "display:<?php echo $saved; ?>;">
		...
		<div class="col-md-12 <?php echo $colour;?>" style="padding:4px 4px 0px 4px;">
			...
			<form method = "POST" id = "lightSwitchForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<input class="form-check-input" type="checkbox" role="switch" id="websiteColour"  onclick="document.getElementById('lightSwitchForm').submit()" <?php if ($_SESSION["lightmode"] == 1){echo "checked";}?>>
				<input type="hidden" name="lightSwitch" value="run">
			</form>
		...
		<form method = "POST" id = "mainForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<div class="col-md-12 <?php echo $colour;?>" style="padding:0px 4px;">
				...
				<input type="password" id = "password2field" name="password2field" class="form-control" id="p2" placeholder="" value="">
			</div>
			<div class="col-md-12 <?php echo $colour;?>" style="padding:0px 4px;">
				<label for="icon" class="form-label">Icon Colour</label>
				<select class="form-select" id="icon" name ="iconField">
		...
		<div class="container <?php echo $colour;?>">
			<div class="row">
				<div class="col-md-6" style="padding:1% 2%;">
					...
					<input type="hidden" name="saveChanges" value="run">
				</div>
				<div class="col-md-6" style="padding:1% 2%;">
	...
	<div class="modal-dialog text-dark">
		...
		<div class="modal-footer">
			...
			<form method = "POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<input type="hidden" name="generateLink" value="run">
