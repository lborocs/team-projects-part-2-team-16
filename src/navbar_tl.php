...
<?php session_start();
	...
	<script>
		function settings() {
			window.location.href = "./settings_tl.php";
		};
		function logout() {
		...
		<div class="container">
			<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
				...
				<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
					<li><a href="./view_team_tl.php" class="nav-link px-2 <?php echo $dashview?>">Dashboard</a></li>
					<li><a href="./view_topics_tl.php" class="nav-link px-2 <?php echo $colour; echo $topicview;?>">Topics</a></li>
					<li><a href="./create_task_tl.php" class="nav-link px-2 <?php echo $colour; echo $taskcreate;?>">Assign Tasks</a></li>
					<li><a href="./view_tasks_tl.php" class="nav-link px-2  <?php echo $colour; echo $taskview;?>">View Tasks</a></li>
				</ul>
